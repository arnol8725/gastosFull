...
@Component({
	...
	templateUrl: '../views/egresos1225.html',
	providers: [ProductoService]
})


export class Egreso1225Component{
...
public ocultarHuellas:boolean=false;
	...
	constructor(
		...
		this.titulo = 'Egreso de Gasto Cuenta Neto';
...
myMethod2(evt){
	...
	opeenvalidacion(){
 		...
 		console.log(this.empleadoObtenido)
			...
			let dia=  this.dialog.open(DialogDataegreso1225Dialog, {
													 		width: '500px',
											                data: {
											                  animal: 'panda',
											                  carga: this.folioADN,
